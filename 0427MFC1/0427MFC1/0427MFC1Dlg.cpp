...
CMy0427MFC1Dlg::~CMy0427MFC1Dlg()
{
	...
	ofstream ofs(_T("C:\\Users\\18045\\Documents\\学生名单.txt"));
...
BOOL CMy0427MFC1Dlg::OnInitDialog()
{
	...
	string s;
	ifstream ifs(_T("C:\\Users\\18045\\Documents\\学生名单.txt"));
	ca.SetSize(100);                           //数组保存列表框的内容
	int i = 0;
	while (ifs >> s)
	{
